 ...
 * @version   2.6.1 for parent theme Default Neuron for publication on ThemeForest
	...
	class TGM_Plugin_Activation {
		...
		public function filter_plugin_action_links_update( $actions ) {
			$actions['update'] = sprintf(
				...
				esc_html__( 'This plugin needs to be updated to be compatible with your theme.', 'tgmpa' ),
